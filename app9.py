...
<head>
    ...
    <title>Corporate Wars Premium</title>
    <style>
...
<div class="container">
    ...
    <div id="setup-screen" class="card">
        ...
        <input type="text" id="ceo-name" placeholder="代表取締役CEO（あなたの名前）">
    ...
    <div id="main-interface" style="display: none;">
        <div class="grid">
            <div class="stat-box">
                ...
                <div style="font-size:20px; font-weight:bold; color:#00ffcc;">￥<span id="header-assets">0</span></div>
            </div>
            <div class="stat-box stock">
                <span style="font-size:12px; color:#aaa;">自社現在株価</span>
                <div style="font-size:20px; font-weight:bold; color:#ffcc00;">￥<span id="header-stock">100</span></div>
            </div>
            <div class="stat-box" style="border-left-color: #ff4444;">
                <span style="font-size:12px; color:#aaa;">社員数 / 生産力</span>
                <div style="font-size:20px; font-weight:bold;"><span id="header-staff">0</span> 名 / <span id="header-power">0</span>/秒</div>
            </div>
        </div>
        ...
        <div class="nav-tabs">
            ...
            <button class="tab-btn" onclick="switchPage('product')">🧪 新商品開発</button>
            <button class="tab-btn" onclick="switchPage('stock')">📈 株価専用窓口</button>
        ...
        <div id="page-concept" class="page-content active">
            <div class="card">
                ...
                <h3>経営アクション</h3>
                <div class="grid">
                    <button class="btn-primary" onclick="manualWork()">社長自ら営業活動を行う (+￥100)</button>
            ...
            <div class="card">
                ...
                <div class="grid" style="margin-top:20px;">
                    <div style="background:#111; padding:20px; border-radius:6px; text-align:center;">
                        ...
                        <div style="font-size:24px; color:#ffcc00; font-weight:bold; margin-top:5px;">￥<span id="stock-market-cap">0</span></div>
                    </div>
                    <div style="background:#111; padding:20px; border-radius:6px; text-align:center;">
                        <span style="font-size:13px; color:#999;">企業格付ランク</span>
                        <div style="font-size:24px; color:#00ffcc; font-weight:bold; margin-top:5px;" id="stock-rank">E</div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    const staffMaster = [
        ...
        { id: "sales", name: "敏腕営業マン", cost: 15000, power: 250, count: 0 },
